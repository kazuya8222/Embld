  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-8 px-6">
      ...
      <div className="space-y-4">
        ...
        <button
          disabled
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#2a2a2a] hover:bg-[#3a3a3a] rounded-xl transition-all duration-200 text-white font-medium border border-[#3a3a3a] hover:border-[#4a4a4a] opacity-50 cursor-not-allowed"
        >
