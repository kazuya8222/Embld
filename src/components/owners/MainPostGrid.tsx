...
interface MainPostGridProps {
  posts: Post[];
}

export function MainPostGrid({ posts }: MainPostGridProps) {
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between text-xs text-gray-500 pt-3 border-t">
              <Link 
                ...
                onClick={(e) => e.stopPropagation()}
              >
                <div className="w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full mr-2 flex items-center justify-center text-white text-xs font-semibold">
