...
import { ownersLogin, ownersLoginWithGoogle } from '../actions';
        ...
        <form className="mt-8 space-y-6" action={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              アカウントをお持ちでない方は{' '}
              <Link href="/owners/auth/register" className="font-medium text-purple-600 hover:text-purple-500">
                新規登録
              </Link>
            </p>
          </div>
